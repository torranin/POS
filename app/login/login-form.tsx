...
export default function LoginForm() {
  ...
  return <main className="login-page">
    <section className="login-visual"><div className="login-brand"><span><HardHat/></span><div><strong>บ้านช่าง</strong><small>BAAN CHANG MATERIALS</small></div></div><div className="login-copy"><p>BUILD • STOCK • SELL</p><h1>จัดการร้านวัสดุก่อสร้าง<br/>ได้ครบในระบบเดียว</h1><span>ขายหน้าร้าน · สต็อกสินค้า · จัดส่ง · รายงาน</span></div><div className="blueprint-lines" aria-hidden="true"><i/><i/><i/></div></section>
